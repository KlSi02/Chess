...
def test_check_surrounded_pieces():
    # Setup Schachbrett und Mock-Objekte
    ...
    # Füge Figuren zum Schachbrett hinzu
    ...
    # Szenario 1: Überprüfen Sie rechts von D4
    ...
    # Szenario 2: Überprüfen Sie links von D4
    ...
    # Szenario 3: Überprüfen Sie oben von D4
    pieces_to_check_moves.clear()
    ...
    # Szenario 4: Überprüfen Sie unten von D4 (keine Figur)
    pieces_to_check_moves.clear()
    check_surrounded_pieces(chessboard, attacker, defender, "D", 4, 0, -1, pieces_to_check_moves, list_of_threatining_pieces)
    assert len(pieces_to_check_moves) == 0

    # Szenario 5: Überprüfen Sie diagonal von D4 (außerhalb des Bretts)
    pieces_to_check_moves.clear()
...
def test_simulate_move_of_important_piece():
    ...
    # Definiere Angreifer und Verteidiger
    attacker = Player(PieceTeam.WHITE)
    attacker.king_position = "E5"

    # Figur in der Nähe des Königs, die sich bewegen kann
